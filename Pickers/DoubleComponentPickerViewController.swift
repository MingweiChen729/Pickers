...
class DoubleComponentPickerViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    private let fillingTypes = ["Ham","Tuna","Peanut Butter","Turkey","Chicken Salad","Roast Beef","Vegemite"]
    ...
    */
    ...
    @IBAction func onButtonPressed(sender: UIButton) {
        let filling = fillingTypes[doublePicker.selectedRowInComponent(fillingComponent)]
        let bread = breadTypes[doublePicker.selectedRowInComponent(breadComponent)]
